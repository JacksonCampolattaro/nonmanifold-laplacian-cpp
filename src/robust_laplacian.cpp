...
#include "../include/nonmanifoldlaplacian/robust_laplacian.h"
...
static constexpr double laplacianReplaceVal = 1.0;
static constexpr double massReplaceVal = -1e-3;


std::tuple<SparseMatrix<double>, SparseMatrix<double>> buildMeshLaplacian(
    const DenseMatrix<double>& vMat,
    const DenseMatrix<size_t>& fMat,
